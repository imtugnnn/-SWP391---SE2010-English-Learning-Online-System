...
namespace EnglishLearningOnlineSystem.Migrations
{
    ...
    [Migration("20260804002309_AddStudentFullNameAndCommunicationLinks")]
    partial class AddStudentFullNameAndCommunicationLinks
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EnglishLearningOnlineSystem.Models.AssignmentActivityProgress", b =>
                {
                    b.Property<int>("ActivityProgressId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ActivityProgressId"));
                    ...
                    b.HasIndex("AssignmentId", "StudentId", "ActivityType", "ActivityId")
                        .IsUnique();

                    b.ToTable("AssignmentActivityProgresses");
                });

            modelBuilder.Entity("EnglishLearningOnlineSystem.Models.AssignmentProgress", b =>
                {
                    b.Property<int>("AssignmentProgressId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("AssignmentProgressId"));
                    ...
                    b.Property<bool>("IsCompletedLate")
                        .HasColumnType("bit");

                    b.Property<int>("RequiredActivityCount")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EnglishLearningOnlineSystem.Models.SystemNotification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EnglishLearningOnlineSystem.Models.SystemSetting", b =>
                {
            ...
            modelBuilder.Entity("EnglishLearningOnlineSystem.Models.WeeklyAssignment", b =>
                {
                    ...
                    b.Property<bool>("IncludeMiniGame")
                        .HasColumnType("bit");

                    b.Property<bool>("IncludeQuiz")
                        .HasColumnType("bit");

                    b.Property<bool>("IncludeVocabulary")
                        .HasColumnType("bit");
                    ...
                    b.HasIndex("ClassId", "LessonId", "WeekStartDate");

                    b.ToTable("WeeklyAssignments");
                });

            modelBuilder.Entity("EnglishLearningOnlineSystem.Models.WeeklyAssignmentMiniGame", b =>
                {
                    b.Property<int>("AssignmentId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("AssignmentId", "GameId");

                    b.HasIndex("GameId");

                    b.ToTable("WeeklyAssignmentMiniGames");
                });

            modelBuilder.Entity("EnglishLearningOnlineSystem.Models.WeeklyAssignmentQuiz", b =>
                {
                    b.Property<int>("AssignmentId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("AssignmentId", "QuizId");

                    b.HasIndex("QuizId");

                    b.ToTable("WeeklyAssignmentQuizzes");
                });

            modelBuilder.Entity("EnglishLearningOnlineSystem.Models.WeeklyAssignmentVocabulary", b =>
                {
                    b.Property<int>("AssignmentId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("AssignmentId", "VocabularyId");

                    b.HasIndex("VocabularyId");

                    b.ToTable("WeeklyAssignmentVocabularies");
                });
            ...
            modelBuilder.Entity("EnglishLearningOnlineSystem.Models.AssignmentActivityProgress", b =>
                {
                    b.HasOne("EnglishLearningOnlineSystem.Models.WeeklyAssignment", "Assignment")
                    ...
                    b.HasOne("EnglishLearningOnlineSystem.Models.StudentProfile", "Student")
                        .WithMany("AssignmentActivityProgresses")
            ...
            modelBuilder.Entity("EnglishLearningOnlineSystem.Models.Notification", b =>
                {
                    ...
                    b.HasOne("EnglishLearningOnlineSystem.Models.TeacherFeedback", "Feedback")
                        .WithMany()
            ...
            modelBuilder.Entity("EnglishLearningOnlineSystem.Models.StudentProfile", b =>
                {
                    b.HasOne("EnglishLearningOnlineSystem.Models.User", "User")
                        ...
                        .HasForeignKey("EnglishLearningOnlineSystem.Models.StudentProfile", "StudentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("EnglishLearningOnlineSystem.Models.StudentProfile", b =>
                {
                    b.Navigation("AssignmentActivityProgresses");
